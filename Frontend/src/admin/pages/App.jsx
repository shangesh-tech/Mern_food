...
const Admin_App = () => {
  ...
  const checkAdminRole = async () => {
    try {
      const response = await axios.get("https://mern-food-bl34.onrender.com/api/v1/check-admin",{ withCredentials: true } );
  ...
  const logout = async () => {
    try {
      const response = await axios.get("https://mern-food-bl34.onrender.com/api/v1/logout",{ withCredentials: true } );
      navigate("/signin");
    } catch (error) {
      console.log(error);
    }
